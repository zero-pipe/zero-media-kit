...
#define FLV_VIDEO_VP8		16 /* ZMK: Enhanced RTMP fourcc vp08 */
#define FLV_VIDEO_VP9		17 /* ZMK: Enhanced RTMP fourcc vp09 */
...
#define FLV_VIDEO_FOURCC_VP8    FLV_VIDEO_FOURCC('v', 'p', '0', '8')
